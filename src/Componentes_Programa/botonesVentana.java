...
public class botonesVentana extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cerrar = new Componentes_Programa.boton();
        minimizar = new Componentes_Programa.boton();
        maximizar = new Componentes_Programa.boton();
   ...
   // funcion.maximizarFrame(minimizar, frame);
    ...
    private Componentes_Programa.boton cerrar;
    private Componentes_Programa.boton maximizar;
    private Componentes_Programa.boton minimizar;
