...
public class ventanaCargaDeCodigo extends javax.swing.JFrame {

    public ventanaCargaDeCodigo() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaCargaDeCodigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaCargaDeCodigo().setVisible(true);
            }
        });
    }
